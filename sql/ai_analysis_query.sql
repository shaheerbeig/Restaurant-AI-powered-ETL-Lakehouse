...
--  here we are justing parsing the JSON response into separate columns for easier analysis and querying
SELECT order_id, customer_id, review_id, restaurant_id, rating, review_text,
  analysis_json, 
